...
ErrorsData$yearmonth <- seq.dates(from = "05/01/2008", "08/01/2021", 
                                  by= "months")
...
forecast <- read_rds("~/.../50_percents_vs_50_percents/country_forecasts.rds")
CalDat <- forecast[161:320, ] #Reading 'test data' forecast data into CalDat|12/2014
...
##Checking results
table(summary(ErrorsData3)) #91 TRUE, 69 FALSE
#(91*100)/159=57.23%=~57%

##Writing ErrosData3 into .rds file
write_rds(ErrorsData3, "~/.../50_percents_vs_50_percents/country_results_table_50Per.rds")

##Reading data
data <- read_rds("~/.../50_percents_vs_50_percents/country_results_table_50Per.rds")

##Analysing data
table(summary(data))
#(91*100)/160=57.23%=~56.87%
