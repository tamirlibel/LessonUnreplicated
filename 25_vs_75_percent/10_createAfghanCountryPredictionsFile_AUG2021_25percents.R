...
#Cutting point for test set --> Row 240, 12/2014| ration:3/4 training, 1/4 test
country_pre <- read_rds("~/.../violent_country_all_years.rds")  #Reading country's data 
...
start <- 240 #Defining starting value-12/2014
